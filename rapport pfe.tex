...
\begin{minipage}[t]{0.30\textwidth}
    \vspace{0pt}
    \raggedright
    \includegraphics[width=3.5cm]{pics/ensam.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.5\textwidth}
    \vspace{0pt}
    \raggedleft
    \includegraphics[width=6cm]{pics/entreprise_vinci_building_solutions.png}
\end{minipage}
...
Encadrante industrielle, VINCI Energies -- CEGELEC \\
\end{tabular}
...
Entreprise d'accueil : & VINCI Energies -- CEGELEC \\
...
This final-year project presents the work carried out at VINCI Energies -- CEGELEC. The project is structured around three complementary contributions: participation in the BIM modelling of the C2R project, the development of a Revit plugin named RESBIM for the automation of structural openings, and the implementation of a BIM--IoT integration based on ESP32, MQTT, Node-RED and Revit for technical building supervision.
...
Ce chapitre présente le cadre industriel dans lequel s'inscrit le projet de fin d'études. Il introduit d'abord VINCI Energies en tant que groupe international spécialisé dans les métiers de l'énergie, des infrastructures et du bâtiment, puis l'entité d'accueil CEGELEC / VINCI Building Solutions. Il présente ensuite la cellule BIM \& Synthèse, qui constitue l'environnement direct du PFE, ainsi que les missions confiées durant le stage.
...
Au Maroc, VINCI Energies intervient à travers plusieurs entités spécialisées, dont CEGELEC. Cette présence locale permet de répondre aux besoins des projets nationaux tout en bénéficiant des méthodes, standards et retours d'expérience du groupe.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.76\textwidth]{pics/entreprise_vinci_building_solutions.png}
    \caption{Positionnement de l'entité d'accueil dans VINCI Building Solutions}
\end{figure}

% ------------------------------------------------------------
\section{Engagement qualité, sécurité et environnement}

Les projets réalisés par CEGELEC s'inscrivent dans une démarche qualité, sécurité et environnement. Cette démarche vise à assurer la conformité des livrables, la maîtrise des risques, la sécurité des équipes et la fiabilité des installations techniques.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.82\textwidth]{pics/charte_qse_cegelec.png}
    \caption{Charte qualité, sécurité et environnement de CEGELEC}
\end{figure}
...
Ce chapitre a permis de présenter l'environnement industriel du projet, depuis VINCI Energies jusqu'à la cellule BIM \& Synthèse. Les activités de CEGELEC, la diversité des lots techniques et les exigences de coordination justifient pleinement le développement d'une solution BIM dédiée à l'automatisation des réservations structurelles.
...
\insertfigure[0.82\textwidth]{pics/fig_conflit_vers_reservation.png}{Transformation d'un conflit MEP--Structure en objet de réservation}
...
\insertfigure[0.92\textwidth]{pics/processus_actuel_reservations.png}{Processus actuel de traitement des réservations structurelles}
...
Au-delà du traitement des réservations, le PFE explore une extension de la maquette BIM vers la supervision technique. Les bâtiments techniques, comme les Data Centers, contiennent des équipements sensibles : baies serveurs, tableaux électriques, équipements CVC, sprinklers et équipements de sécurité. La possibilité de connecter ces objets BIM à des données issues d'un ESP32 permet d'utiliser Revit comme support de visualisation des états techniques.

Cette extension ne remplace pas le travail RESBIM. Elle constitue un second axe complémentaire qui montre comment une maquette structurée peut évoluer vers un support de supervision dynamique.

\section{Problématique finale}
La problématique du PFE peut être formulée comme suit :

\importantbox{
\textbf{Comment concevoir et développer une solution BIM intégrée permettant d'automatiser la génération, le dimensionnement, la vérification et le suivi des réservations structurelles, tout en réduisant le temps de traitement et en améliorant la traçabilité dans une maquette Revit multidisciplinaire ?}
}
...
\begin{itemize}[leftmargin=1.2cm]
    ...
    \item développer une chaîne BIM--IoT basée sur ESP32, MQTT, Node-RED et Revit ;
...
\insertfigure[0.82\textwidth]{pics/clash_detection_mep_structure.png}{Principe de détection des conflits MEP--Structure}
...
\insertfigure[0.82\textwidth]{pics/dynamo_api_revit.png}{Dynamo et API Revit dans une démarche d'automatisation}
...
\section{Valeur ajoutée pour VINCI Energies / CEGELEC}
Pour VINCI Energies et CEGELEC, le projet apporte :
\begin{itemize}[leftmargin=1.2cm]
